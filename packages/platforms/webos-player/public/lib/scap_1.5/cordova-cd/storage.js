Storage = (function () {
  ...
  e.prototype.upgradeFirmware = function (g, h, i) {
    var j = {};
    ...
    a.Request("luna://com.webos.service.commercial.signage.storageservice", {
      ...
      onSuccess: function (i) {
        if (i.returnValue === true) {
          g({
            status: i.status,
            upgradeProgress: i.upgradeProgress,
            downloadProgress: i.downloadProgress,
          });
        } else {
          h({ errorCode: i.errorCode, errorText: i.errorText });
        }
      },
  ...
  e.prototype.upgradeApplication = function (g, h, i) {
    var j = {
      from: "remote",
      to: i === undefined || i === null ? e.AppMode.LOCAL : i.to,
      recovery: i === undefined || i === null ? false : i.recovery,
    };
  ...
  e.prototype.copyFile = function (g, h, i) {
    ...
    if (typeof i.httpOption.maxRedirection !== "undefined") {
      if (typeof i.maxRedirection !== "undefined") {
        ...
        i.maxRedirection = i.httpOption.maxRedirection;
      }
    }
    d(i);
    a.Request("luna://com.webos.service.commercial.signage.storageservice", {
      ...
      parameters: {
        dest: i.destination,
        src: i.source,
        ftpOption: i.ftpOption,
        httpOption: i.httpOption,
      },
      onSuccess: function (j) {
        if (j.returnValue === true) {
          d("SUCCESS");
  ...
  e.prototype.listFiles = function (g, h, i) {
    var j = {};
    if (i && i.path) {
      if (f(i.path)) {
        j.pathURI = i.path;
    ...
    a.Request("luna://com.webos.service.commercial.signage.storageservice/", {
      ...
      onSuccess: function (k) {
        if (k.returnValue === true) {
          var m = [];
          for (var l = 0; l < k.files.length; ++l) {
            d(k.files[l]);
            var o = {
              name: k.files[l].name,
          ...
          var n = { files: m, totalCount: k.totalCount };
          g(n);
        } else {
          h({ errorCode: k.errorCode, errorText: k.errorText });
        }
      ...
      onSuccess: function (i) {
        ...
        if (i.returnValue === true) {
          ...
          var j = {
            ...
            used: i.spaceInfo.usedSize,
            externalMemory: i.externalStorage,
          };
          g(j);
        } else {
          h({ errorCode: i.errorCode, errorText: i.errorText });
                  ...
                  if (
                    ...
                    if (y.encoding === "binary") {
                      ...
                      if (y.encoding === "base64") {
                        ...
                        var r = m.length ? m.length : e.MAX_BUFFER_LENGTH;
                        y.data = m.data.substring(p, p + r);
                        y.length = y.data.length;
                        y.offset = 0;
                      }
                    }
                    try {
  ...
  e.prototype.fsync = function (g, h, i) {
    try {
      var k = {};
      if (i && i.path) {
        if (f(i.path)) {
  ...
  var b = function (g, h, i) {
    var j = a.Request("luna://com.webos.service.commercial.signage.storageservice", {
  ...
  e.prototype.getDownloadFileStatus = function (g, h, i) {
    b(g, h, i);
  };
  return e;
})();
