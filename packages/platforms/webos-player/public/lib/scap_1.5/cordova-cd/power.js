Power = (function () {
      ...
      e.Request = function (k, m) {
        ...
        var p = function (q) {
          ...
          if (q.payload.returnValue === true) {
            ...
            o.returnValue = false;
            o.errorCode = q.payload.errorCode;
            o.errorText = q.payload.errorText;
            m.onFailure(o);
          }
        };
        if (e) {
  ...
  function g(k, l, j) {
    if (k.errorCode === undefined || k.errorCode === null) {
      k.errorCode = l;
    }
    if (k.errorText === undefined || k.errorText === null) {
      k.errorText = j;
    }
  }
  function c(k, j) {
        ...
        e.Request('luna://com.webos.service.commercial.scapadapter/settings/', {
          ...
          onSuccess: function (o) {
            if (o.returnValue === true) {
              ...
              s = {};
              var r =
                o.settings.onOffTimeSchedule.onTime === null ||
                o.settings.onOffTimeSchedule.onTime === undefined
                  ? 0
                  : o.settings.onOffTimeSchedule.onTime.length;
              for (t = 0; t < r; t++) {
                if (
                  o.settings.onOffTimeSchedule.onTime[t].day !== undefined &&
                  o.settings.onOffTimeSchedule.onTime[t].day !== null
                ) {
                  s.day = o.settings.onOffTimeSchedule.onTime[t].day;
                }
                if (
                  o.settings.onOffTimeSchedule.onTime[t].hour !== undefined &&
                  o.settings.onOffTimeSchedule.onTime[t].hour !== null
                ) {
                  s.hour = o.settings.onOffTimeSchedule.onTime[t].hour;
                }
                if (
                  o.settings.onOffTimeSchedule.onTime[t].minute !== undefined &&
                  o.settings.onOffTimeSchedule.onTime[t].minute !== null
                ) {
                  s.minute = o.settings.onOffTimeSchedule.onTime[t].minute;
                }
                q.onTime.push(s);
                s = {};
              }
              var u =
                o.settings.onOffTimeSchedule.offTime === null ||
                o.settings.onOffTimeSchedule.offTime === undefined
                  ? 0
                  : o.settings.onOffTimeSchedule.offTime.length;
              for (t = 0; t < u; t++) {
                if (
                  o.settings.onOffTimeSchedule.offTime[t].day !== undefined &&
                  o.settings.onOffTimeSchedule.offTime[t].day !== null
                ) {
                  s.day = o.settings.onOffTimeSchedule.offTime[t].day;
                }
                if (
                  o.settings.onOffTimeSchedule.offTime[t].hour !== undefined &&
                  o.settings.onOffTimeSchedule.offTime[t].hour !== null
                ) {
        ...
        e.Request('luna://com.webos.service.commercial.scapadapter/settings/', {
          ...
          onSuccess: function (x) {
            if (x.returnValue === true) {
              ...
              q.minute = l.minute;
              var t =
                x.settings.onOffTimeSchedule.onTime === null ||
                x.settings.onOffTimeSchedule.onTime === undefined
                  ? 0
                  : x.settings.onOffTimeSchedule.onTime.length;
              var p = false;
              for (r = 0; r < t; r++) {
                if (
                  x.settings.onOffTimeSchedule.onTime[r].day !== undefined &&
                  x.settings.onOffTimeSchedule.onTime[r].day !== null
                ) {
                  if (c(x.settings.onOffTimeSchedule.onTime[r].day, q.day)) {
                    o++;
                  } else {
                    v.day = x.settings.onOffTimeSchedule.onTime[r].day;
                  }
                }
                if (
                  x.settings.onOffTimeSchedule.onTime[r].hour !== undefined &&
                  x.settings.onOffTimeSchedule.onTime[r].hour !== null
                ) {
                  if (x.settings.onOffTimeSchedule.onTime[r].hour === q.hour) {
                    o++;
                  } else {
                    v.hour = x.settings.onOffTimeSchedule.onTime[r].hour;
                  }
                }
                if (
              ...
              var u =
                x.settings.onOffTimeSchedule.offTime === null ||
                x.settings.onOffTimeSchedule.offTime === undefined
                  ? 0
                  : x.settings.onOffTimeSchedule.offTime.length;
              for (r = 0; r < u; r++) {
                if (
                  x.settings.onOffTimeSchedule.offTime[r].day !== undefined &&
                  x.settings.onOffTimeSchedule.offTime[r].day !== null
                ) {
                  v.day = x.settings.onOffTimeSchedule.offTime[r].day;
                }
                if (
                  x.settings.onOffTimeSchedule.offTime[r].hour !== undefined &&
                  x.settings.onOffTimeSchedule.offTime[r].hour !== null
                ) {
            ...
            if (x.returnValue === true) {
              ...
              for (r = 0; r < u; r++) {
                if (
                  ...
                  if (c(x.settings.onOffTimeSchedule.offTime[r].day, q.day)) {
                    o++;
                  } else {
                    v.day = x.settings.onOffTimeSchedule.offTime[r].day;
                  }
                ...
                if (
                  ...
                  if (x.settings.onOffTimeSchedule.offTime[r].hour === q.hour) {
                    o++;
                  } else {
                    v.hour = x.settings.onOffTimeSchedule.offTime[r].hour;
                  }
          ...
          onSuccess: function (m) {
            if (m.returnValue === true) {
              ...
              for (var p = 0, q = 0; q < t.length; q++, p++) {
                if (
                  m.settings.onOffTimeSchedule.onTime[q] === null ||
                  m.settings.onOffTimeSchedule.onTime[q] === undefined
                ) {
                  continue;
                }
                t[p] = { hour: 0, minute: 0, week: 0 };
                ...
                t[p].hour = m.settings.onOffTimeSchedule.onTime[q].hour;
                t[p].minute = m.settings.onOffTimeSchedule.onTime[q].minute;
                t[p].week = n;
              }
              s.timerList = t;
              if (typeof j === 'function') {
        ...
        e.Request('luna://com.webos.service.commercial.scapadapter/settings/', {
          ...
          onSuccess: function (m) {
            if (m.returnValue === true) {
              ...
              for (var p = 0, q = 0; q < t.length; q++, p++) {
                if (
                  m.settings.onOffTimeSchedule.offTime[q] === null ||
                  m.settings.onOffTimeSchedule.offTime[q] === undefined
                ) {
                  continue;
                }
                t[p] = { hour: 0, minute: 0, week: 0 };
                ...
                t[p].hour = m.settings.onOffTimeSchedule.offTime[q].hour;
                t[p].minute = m.settings.onOffTimeSchedule.offTime[q].minute;
                t[p].week = n;
              }
              s.timerList = t;
              if (typeof j === 'function') {
