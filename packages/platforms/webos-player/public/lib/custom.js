    ...
    getAvSync: function (a, t) {
      w("getAvSync", t, function () {
        F.getValue(
          ...
          [g],
          function (e) {
            y.callSuccessCallback(a, { avSync: e.avSync });
          },
          function (e) {
            y.callFailureCallback(
              t,
    ...
    getNoSignalImageStatus: function (a, t) {
      w("getNoSignalImageStatus", t, function () {
        F.getValue(
          ...
          [I],
          function (e) {
            y.callSuccessCallback(a, { noSignalImage: e.noSignalImage });
          },
          function (e) {
            y.callFailureCallback(
              t,
      ...
      w("getPowerOnOffHistory", a, function () {
        F.getValue(
          ...
          function (e) {
            ...
            y.callSuccessCallback(n, { powerOnOffHistory: a });
          },
          function (e) {
            y.callFailureCallback(
              a,
    ...
    getPowerOnStatus: function (a, t) {
      w("getPowerOnStatus", t, function () {
        F.getValue(
          ...
          [M],
          function (e) {
            y.callSuccessCallback(a, { powerOnStatus: e.powerOnStatus });
          },
          function (e) {
            y.callFailureCallback(
              t,
      ...
      w("getNativePortraitMode", t, function () {
        3 === s.webOSVersion
          ? F.getValue(
              ...
              [b],
              function (e) {
                y.callSuccessCallback(a, { nativePortrait: e[b] });
              },
              function (e) {
                y.callFailureCallback(
                  t,
          ...
          : 3.2 <= s.webOSVersion
            ? F.getValue(
                ...
                [A],
                function (e) {
                  y.callSuccessCallback(a, { nativePortrait: e[A] });
                },
                function (e) {
                  y.callFailureCallback(
                    t,
        ...
        !1 !== D.checkMissingParameters(e, ["nativePortrait"])
          ? !1 !== D.checkParametersValidation(c.NATIVEPORTRAIT, e, "nativePortrait")
            ? 3 === s.webOSVersion
              ? F.setValue(
                  R,
                  { siAppOrientation: e.nativePortrait },
                  function (e) {
                    y.callSuccessCallback(a);
                  },
                  function (e) {
              ...
              : 3.2 <= s.webOSVersion
                ? F.setValue(
                    u,
                    { screenRotation: e.nativePortrait },
                    function (e) {
                      y.callSuccessCallback(a);
                    },
                    function (e) {
