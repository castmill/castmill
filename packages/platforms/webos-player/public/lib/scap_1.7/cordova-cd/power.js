Power = (function () {
  ...
  c.PowerCommand = { SHUTDOWN: "powerOff", REBOOT: "reboot" };
  c.DisplayMode = { DISPLAY_OFF: "Screen Off", DISPLAY_ON: "Active" };
  c.TimerWeek = {
    MONDAY: 1,
    TUESDAY: 2,
    WEDNESDAY: 4,
  ...
  c.DPMSignalType = { CLOCK: "clock", CLOCK_WITH_DATA: "clockAndData" };
  c.PMMode = {
    PowerOff: "powerOff",
  ...
  c.prototype.enableAllOnTimer = function (h, i, j) {
    ...
    b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
      method: "set",
      parameters: { category: "time", settings: { onTimerEnable: k } },
      onSuccess: function () {
          ...
          b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
            ...
            onSuccess: function (l) {
              if (l.returnValue === true) {
                ...
                var n = {};
                var p =
                  l.settings.onOffTimeSchedule.offTime === null ||
                  l.settings.onOffTimeSchedule.offTime === undefined
                    ? 0
                    : l.settings.onOffTimeSchedule.offTime.length;
                for (o = 0; o < p; o++) {
                  if (
                    l.settings.onOffTimeSchedule.offTime[o].day !== undefined &&
                    l.settings.onOffTimeSchedule.offTime[o].day !== null
                  ) {
                    n.day = l.settings.onOffTimeSchedule.offTime[o].day;
                  }
                  if (
                    l.settings.onOffTimeSchedule.offTime[o].hour !== undefined &&
                    l.settings.onOffTimeSchedule.offTime[o].hour !== null
                  ) {
                    n.hour = l.settings.onOffTimeSchedule.offTime[o].hour;
                  }
                  if (
                    l.settings.onOffTimeSchedule.offTime[o].minute !== undefined &&
                    l.settings.onOffTimeSchedule.offTime[o].minute !== null
                  ) {
                ...
                b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
                  method: "set",
                  parameters: { category: "commercial", settings: { onOffTimeSchedule: m } },
                  onSuccess: function () {
  ...
  c.prototype.enableAllOffTimer = function (h, i, j) {
    ...
    b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
      method: "set",
      parameters: { category: "time", settings: { offTimerEnable: k } },
      onSuccess: function () {
          ...
          b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
            ...
            onSuccess: function (l) {
              if (l.returnValue === true) {
                ...
                var n = {};
                var p =
                  l.settings.onOffTimeSchedule.onTime === null ||
                  l.settings.onOffTimeSchedule.onTime === undefined
                    ? 0
                    : l.settings.onOffTimeSchedule.onTime.length;
                for (o = 0; o < p; o++) {
                  if (
                    l.settings.onOffTimeSchedule.onTime[o].day !== undefined &&
                    l.settings.onOffTimeSchedule.onTime[o].day !== null
                  ) {
                    n.day = l.settings.onOffTimeSchedule.onTime[o].day;
                  }
                  if (
                    l.settings.onOffTimeSchedule.onTime[o].hour !== undefined &&
                    l.settings.onOffTimeSchedule.onTime[o].hour !== null
                  ) {
                    n.hour = l.settings.onOffTimeSchedule.onTime[o].hour;
                  }
                  if (
                    l.settings.onOffTimeSchedule.onTime[o].minute !== undefined &&
                    l.settings.onOffTimeSchedule.onTime[o].minute !== null
                  ) {
  ...
  c.prototype.addOnTimer = function (h, i, j) {
    ...
    if (
      ...
      j.minute === undefined ||
      isNaN(j.minute) ||
      typeof j.minute !== "number" ||
      j.minute < 0 ||
      j.minute > 59 ||
      j.week === undefined ||
      isNaN(j.week) ||
      typeof j.week !== "number" ||
      j.week <= 0 ||
      j.week > 127
    ) {
      if (typeof i === "function") {
    ...
    b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
      ...
      onSuccess: function (k) {
        if (k.returnValue === true) {
          var q =
            k.settings.onOffTimeSchedule.onTime === null ||
            k.settings.onOffTimeSchedule.onTime === undefined
              ? 0
              : k.settings.onOffTimeSchedule.onTime.length;
          var p =
            k.settings.onOffTimeSchedule.offTime === null ||
            k.settings.onOffTimeSchedule.offTime === undefined
              ? 0
              : k.settings.onOffTimeSchedule.offTime.length;
          if (q >= 7) {
            i({
              errorCode: "ON_TIMER_SCHEDULE_FULL",
              errorText: "Unable to add OnTimer. OnTimer schedule is full.",
            });
            return;
          } else {
            var o;
            ...
            for (o = 0; o < q; o++) {
              if (
                k.settings.onOffTimeSchedule.onTime[o].day !== undefined &&
                k.settings.onOffTimeSchedule.onTime[o].day !== null
              ) {
                n.day = k.settings.onOffTimeSchedule.onTime[o].day;
              }
              if (
                k.settings.onOffTimeSchedule.onTime[o].hour !== undefined &&
                k.settings.onOffTimeSchedule.onTime[o].hour !== null
              ) {
                n.hour = k.settings.onOffTimeSchedule.onTime[o].hour;
              }
              if (
                k.settings.onOffTimeSchedule.onTime[o].minute !== undefined &&
                k.settings.onOffTimeSchedule.onTime[o].minute !== null
              ) {
                n.minute = k.settings.onOffTimeSchedule.onTime[o].minute;
              }
              m.onTime.push(n);
              n = {};
            }
            for (o = 0; o < p; o++) {
              if (
                k.settings.onOffTimeSchedule.offTime[o].day !== undefined &&
                k.settings.onOffTimeSchedule.offTime[o].day !== null
              ) {
                n.day = k.settings.onOffTimeSchedule.offTime[o].day;
              }
              if (
                k.settings.onOffTimeSchedule.offTime[o].hour !== undefined &&
                k.settings.onOffTimeSchedule.offTime[o].hour !== null
              ) {
                n.hour = k.settings.onOffTimeSchedule.offTime[o].hour;
              }
              if (
                k.settings.onOffTimeSchedule.offTime[o].minute !== undefined &&
                k.settings.onOffTimeSchedule.offTime[o].minute !== null
              ) {
                n.minute = k.settings.onOffTimeSchedule.offTime[o].minute;
              }
              m.offTime.push(n);
              n = {};
            }
    ...
    b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
      ...
      onSuccess: function (t) {
        if (t.returnValue === true) {
          ...
          m.minute = j.minute;
          var p =
            t.settings.onOffTimeSchedule.onTime === null ||
            t.settings.onOffTimeSchedule.onTime === undefined
              ? 0
              : t.settings.onOffTimeSchedule.onTime.length;
          var l = false;
          for (n = 0; n < p; n++) {
            if (
              t.settings.onOffTimeSchedule.onTime[n].day !== undefined &&
              t.settings.onOffTimeSchedule.onTime[n].day !== null &&
              t.settings.onOffTimeSchedule.onTime[n].hour !== undefined &&
              t.settings.onOffTimeSchedule.onTime[n].hour !== null &&
              t.settings.onOffTimeSchedule.onTime[n].minute !== undefined &&
              t.settings.onOffTimeSchedule.onTime[n].minute !== null
            ) {
              if (
                a(t.settings.onOffTimeSchedule.onTime[n].day, m.day) &&
                t.settings.onOffTimeSchedule.onTime[n].hour === m.hour &&
                t.settings.onOffTimeSchedule.onTime[n].minute === m.minute
              ) {
                l = true;
              } else {
          ...
          var q =
            t.settings.onOffTimeSchedule.offTime === null ||
            t.settings.onOffTimeSchedule.offTime === undefined
              ? 0
              : t.settings.onOffTimeSchedule.offTime.length;
          for (n = 0; n < q; n++) {
            if (
              t.settings.onOffTimeSchedule.offTime[n].day !== undefined &&
              t.settings.onOffTimeSchedule.offTime[n].day !== null
            ) {
              r.day = t.settings.onOffTimeSchedule.offTime[n].day;
            }
            if (
              t.settings.onOffTimeSchedule.offTime[n].hour !== undefined &&
              t.settings.onOffTimeSchedule.offTime[n].hour !== null
            ) {
              r.hour = t.settings.onOffTimeSchedule.offTime[n].hour;
            }
            if (
              t.settings.onOffTimeSchedule.offTime[n].minute !== undefined &&
              t.settings.onOffTimeSchedule.offTime[n].minute !== null
            ) {
          ...
          if (l) {
            b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
              method: "set",
              parameters: { category: "commercial", settings: { onOffTimeSchedule: o } },
              onSuccess: function () {
    ...
    b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
      ...
      onSuccess: function (k) {
        if (k.returnValue === true) {
          ...
          if (p >= 7) {
            i({
              errorCode: "OFF_TIMER_SCHEDULE_FULL",
              errorText: "Unable to add OffTimer. OffTimer schedule is full.",
            });
            return;
          } else {
            var o;
        ...
        if (t.returnValue === true) {
          ...
          for (n = 0; n < q; n++) {
            if (
              ...
              if (
                a(t.settings.onOffTimeSchedule.offTime[n].day, m.day) &&
                t.settings.onOffTimeSchedule.offTime[n].hour === m.hour &&
                t.settings.onOffTimeSchedule.offTime[n].minute === m.minute
              ) {
                l = true;
              } else {
                r.day = t.settings.onOffTimeSchedule.offTime[n].day;
      ...
      onSuccess: function (k) {
        if (k.returnValue === true) {
          ...
          for (var n = 0, o = 0; o < r.length; o++, n++) {
            if (
              k.settings.onOffTimeSchedule.onTime[o] === null ||
              k.settings.onOffTimeSchedule.onTime[o] === undefined
            ) {
              continue;
            }
    ...
    b.Request("luna://com.webos.service.commercial.scapadapter/settings/", {
      ...
      onSuccess: function (k) {
        if (k.returnValue === true) {
          ...
          for (var n = 0, o = 0; o < r.length; o++, n++) {
            if (
              k.settings.onOffTimeSchedule.offTime[o] === null ||
              k.settings.onOffTimeSchedule.offTime[o] === undefined
            ) {
              continue;
            }
            r[n] = { hour: 0, minute: 0, week: 0 };
  ...
  c.prototype.setDisplayMode = function (g, h, i) {
    ...
    b.Request("luna://com.webos.service.commercial.scapadapter/power", {
      ...
      parameters: { displayMode: i.displayMode },
      onSuccess: function (j) {
  ...
  c.prototype.executePowerCommand = function (g, h, i) {
    ...
    b.Request("luna://com.webos.service.commercial.scapadapter/power", {
      ...
      parameters: { powerCommand: i.powerCommand },
      onSuccess: function (j) {
