            ...
            'luna://com.webos.service.commercial.scapadapter/settings/',
            {
              ...
              onSuccess: function (l) {
                if (l.returnValue === true) {
                  ...
                  for (o = 0; o < p; o++) {
                    if (
                      l.settings.onOffTimeSchedule.offTime[o].day !==
                        undefined &&
                    ...
                    if (
                      l.settings.onOffTimeSchedule.offTime[o].hour !==
                        undefined &&
                    ...
                    if (
                      l.settings.onOffTimeSchedule.offTime[o].minute !==
                        undefined &&
            ...
            'luna://com.webos.service.commercial.scapadapter/settings/',
            {
              ...
              onSuccess: function (l) {
                if (l.returnValue === true) {
                  ...
                  for (o = 0; o < p; o++) {
                    if (
                      l.settings.onOffTimeSchedule.onTime[o].day !==
                        undefined &&
                    ...
                    if (
                      l.settings.onOffTimeSchedule.onTime[o].hour !==
                        undefined &&
                    ...
                    if (
                      l.settings.onOffTimeSchedule.onTime[o].minute !==
                        undefined &&
