cordova.define("cordova/plugin/signage", function (k, B, c) {
  ...
  var x = function (D) {
    var E = n[D];
    i(JSON.stringify(E, null, 3));
    if (E && E.getEvent === true) {
      if (n[D].listenerObj) {
        n[D].getEvent = false;
  ...
  var n = {
    fan: { getEvent: false, listenerObj: null, createListener: g },
    screen: { getEvent: false, listenerObj: null, createListener: y },
    temperature: { getEvent: false, listenerObj: null, createListener: t },
    signal: { getEvent: false, listenerObj: null, createListener: r },
    lamp: { getEvent: false, listenerObj: null, createListener: j },
  };
  ...
  a.RS232C.DataBit = { BIT_7: 7, BIT_8: 8, BIT_UNKNOWN: 0 };
  a.RS232C.FlowControl = { UNKNOWN: 0, NONE: 1, XON_XOFF: 2, HARDWARE: 3 };
  ...
  a.prototype.getFailoverMode = function (D, E) {
    C.Request("luna://com.webos.service.commercial.scapadapter/signage", {
      ...
      onSuccess: function (F) {
        ...
        D({ priority: F.priority, mode: F.mode });
      },
      onFailure: function (F) {
        delete F.returnValue;
        E(F);
  ...
  a.prototype.getSystemMonitoringInfo = function (D, E) {
    if (n) {
      D({
        fan: n.fan.getEvent,
        signal: n.signal.getEvent,
        lamp: n.lamp.getEvent,
        screen: n.screen.getEvent,
  ...
  a.prototype.setPowerSaveMode = function (D, E, H) {
    var G;
    function F(J) {
      if (J.powerSaveMode) {
  ...
  a.prototype.addEventListener = p;
