import { promisify, promisifyNoOpt, promisifyNoRet, promisifyNoOptNoRet } from "./promisify";
...
export const deviceInfo = {
  getPlatformInfo: promisifyNoOpt(scapDeviceInfo.getPlatformInfo.bind(scapDeviceInfo)),
  getNetworkMacInfo: promisifyNoOpt(scapDeviceInfo.getNetworkMacInfo.bind(scapConfig)),
};
...
export const signage = {
  registerSystemMonitor: promisifyNoRet(scapSignage.registerSystemMonitor.bind(scapSignage)),
...
export const power = {
  executePowerCommand: promisifyNoRet(scapPower.executePowerCommand.bind(scapPower)),
...
export const configuration = {
  restartApplication: promisifyNoOptNoRet(scapConfig.restartApplication.bind(scapConfig)),
  getServerProperty: promisifyNoOpt(scapConfig.getServerProperty.bind(scapConfig)),
  setServerProperty: promisifyNoRet(scapConfig.setServerProperty.bind(scapConfig)),
};

export const storage = {
  upgradeApplication: promisifyNoRet(scapStorage.upgradeApplication.bind(scapStorage)),
  downloadFirmware: promisifyNoRet(scapStorage.downloadFirmware.bind(scapStorage)),
  upgradeFirmware: promisifyNoOptNoRet(scapStorage.upgradeFirmware.bind(scapStorage)),
