...
describe("formatBytes", () => {
  describe("edge cases", () => {
    ...
    it("should throw error for negative values", () => {
      expect(() => formatBytes(-1)).toThrow("formatBytes: bytes must be non-negative");
      expect(() => formatBytes(-100)).toThrow("formatBytes: bytes must be non-negative");
      expect(() => formatBytes(-1024)).toThrow("formatBytes: bytes must be non-negative");
    });
  });
