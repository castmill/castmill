...
describe("StyledInput Component", () => {
  ...
  it("renders correctly with default props", () => {
    ...
    render(() => <StyledInput id="test-input" value="" onInput={mockOnInput} />);
  ...
  it("updates on user input", () => {
    const mockOnInput = vi.fn();
    render(() => <StyledInput id="test-input" value="Hello" onInput={mockOnInput} />);
  ...
  it("is disabled when the disabled prop is true", () => {
    const mockOnInput = vi.fn();
    render(() => (
      <StyledInput id="test-input" value="Hello" onInput={mockOnInput} disabled={true} />
    ));
    const input = screen.getByRole("textbox");
