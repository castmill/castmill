...
describe("Toast Component", () => {
  ...
  it("renders with success type", () => {
    render(() => <Toast id="test-2" message="Success message" type="success" />);
  ...
  it("renders with warning type", () => {
    render(() => <Toast id="test-4" message="Warning message" type="warning" />);
    const toast = screen.getByTestId("toast");
    expect(toast).toBeInTheDocument();
  ...
  it("calls onClose when close button is clicked", () => {
    ...
    render(() => <Toast id="test-6" message="Test" type="info" onClose={mockOnClose} />);
  ...
  it("auto-closes after specified duration", () => {
    const mockOnClose = vi.fn();
    render(() => (
      <Toast id="test-7" message="Test" type="info" duration={3000} onClose={mockOnClose} />
    ));
  ...
  it("does not auto-close when duration is 0", () => {
    const mockOnClose = vi.fn();
    render(() => (
      <Toast id="test-8" message="Test" type="info" duration={0} onClose={mockOnClose} />
    ));
  ...
  it("cleans up timers on unmount", () => {
    ...
    const { unmount } = render(() => (
      <Toast id="test-10" message="Test" type="info" duration={5000} onClose={mockOnClose} />
    ));
