...
describe("TagBadge", () => {
  ...
  describe("click handling", () => {
    it("calls onClick when clicked", async () => {
      const tag = createTag();
      const onClick = vi.fn();
      const { container } = render(() => <TagBadge tag={tag} onClick={onClick} />);
      const badge = container.querySelector(".castmill-tag-badge")!;
    ...
    it('has role="button" when onClick is set', () => {
      const tag = createTag();
      const { container } = render(() => <TagBadge tag={tag} onClick={() => {}} />);
      const badge = container.querySelector(".castmill-tag-badge");
    ...
    it("does not call onClick when disabled", async () => {
      const tag = createTag();
      const onClick = vi.fn();
      const { container } = render(() => <TagBadge tag={tag} onClick={onClick} disabled={true} />);
      const badge = container.querySelector(".castmill-tag-badge")!;
      await fireEvent.click(badge);
    ...
    it("applies disabled class when disabled", () => {
      const tag = createTag();
      const { container } = render(() => <TagBadge tag={tag} disabled={true} />);
      const badge = container.querySelector(".castmill-tag-badge");
  ...
  describe("remove button", () => {
    ...
    it("does not call onRemove when disabled", async () => {
      ...
      const onRemove = vi.fn();
      const { container } = render(() => (
        <TagBadge tag={tag} removable={true} onRemove={onRemove} disabled={true} />
      ));
      const removeBtn = container.querySelector(".tag-remove")!;
      await fireEvent.click(removeBtn);
