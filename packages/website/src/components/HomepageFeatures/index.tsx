...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Create stunning digital signage content without coding. Use our flexible template system to
        build widgets for any use case - from menu boards to real estate displays.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Deploy anywhere with our lightweight HTML5 player. Works on web browsers, embedded devices,
        Android, webOS TVs, and Electron desktop applications.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Built for reliability with offline operation, low memory usage, and modular design. Includes
        dashboard, player, server, and device management.
      </>
    ),
  },
];
...
function Feature({ title, icon, description }: FeatureItem) {
  const iconMap = {
    ...
    enterprise: (
      ...
      >
        ...
        <path
          d="M30 80 Q30 70 40 70 Q50 70 50 80 L50 100 Q50 110 40 110 Q30 110 30 100 Z"
          fill="currentColor"
          opacity="0.4"
        />
  ...
  return (
    <div className={clsx("col col--4")}>
      <div className="text--center">{iconMap[icon as keyof typeof iconMap]}</div>
