...
const FeatureList: FeatureItem[] = [
  ...
  },
  {
    ...
    description: (
      <>
        Deploy anywhere with our lightweight HTML5 player. Works on web
        browsers, embedded devices, Android, webOS TVs, and Electron desktop
        applications.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        ...
        modular design. Includes dashboard, player, server, and device
        management.
      </>
    ),
  },
  ...
  const iconMap = {
    ...
    enterprise: (
      ...
      >
        ...
        />
        <path
          d="M92 17 Q100 10 108 17"
          stroke="currentColor"
          strokeWidth="2"
          fill="none"
        />
        <path
          d="M88 13 Q100 3 112 13"
          stroke="currentColor"
          strokeWidth="2"
          fill="none"
        />
