...
describe("PlaylistsService", () => {
  ...
  describe("updatePlaylist", () => {
    it("should update playlist with aspect ratio settings", async () => {
      ...
      await PlaylistsService.updatePlaylist(baseUrl, organizationId, playlistId, playlistUpdate);
  ...
  describe("getWidgets", () => {
    ...
    it("should fetch widgets with search parameter", async () => {
      ...
      const result = await PlaylistsService.getWidgets(baseUrl, organizationId, searchTerm);
    ...
    it("should throw an error when fetching widgets fails", async () => {
      ...
      await expect(PlaylistsService.getWidgets(baseUrl, organizationId)).rejects.toThrow(
  ...
  describe("fetchPlaylists", () => {
    it("should fetch playlists with search parameter", async () => {
      ...
      const result = await PlaylistsService.fetchPlaylists(baseUrl, organizationId, {
        page: 1,
        page_size: 10,
        sortOptions: {},
        search: "test",
