defmodule Castmill.Organizations do
  ...
  """
  def update_access(organization_id, user_id, access) do
    %Castmill.Organizations.OrganizationsUsers{access: access, user_id: user_id, organization_id: organization_id}
    |> Castmill.Repo.insert(
      on_conflict: [set: [access: access]],
  ...
  # TODO: The following functions are not used, but they are generated by the Phoenix generators.
