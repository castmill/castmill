...
const versionInfo = {
  ...
  build: {
    castmill_git_sha:
      process.env.VITE_CASTMILL_GIT_SHA || process.env.CASTMILL_GIT_SHA || "unknown",
    built_at:
      process.env.VITE_BUILD_TIME || process.env.CASTMILL_BUILD_TIME || new Date().toISOString(),
  },
  runtime: {
