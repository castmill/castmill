...
describe("NetworkService", () => {
  ...
  describe("updateSettings", () => {
    ...
    it("throws error for non-admin user", async () => {
      ...
      await expect(NetworkService.updateSettings({ name: "Hacked" })).rejects.toThrow();
    });
  });
  ...
  describe("createOrganization", () => {
    it("creates a new organization", async () => {
      ...
      const result = await NetworkService.createOrganization("New Organization");
    ...
    it("throws error for non-admin user", async () => {
      ...
      await expect(NetworkService.createOrganization("Unauthorized Org")).rejects.toThrow();
    });
