import { OnboardingStep, OnboardingStepConfig } from "../interfaces/onboarding-progress.interface";
 ...
 */
export function getNextStep(completedSteps: OnboardingStep[]): OnboardingStep | null {
 ...
 */
export function isOnboardingComplete(completedSteps: OnboardingStep[]): boolean {
