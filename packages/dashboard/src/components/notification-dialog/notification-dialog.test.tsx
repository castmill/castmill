...
describe("NotificationDialog Component", () => {
  ...
  it("should render the dialog", async () => {
    ...
    renderWithI18n(() => (
      <NotificationDialog onClose={onClose} onNotificationRead={onNotificationRead} />
    ));
  ...
  it("should handle service errors gracefully", async () => {
    (notificationsService.getNotifications as any).mockRejectedValue(new Error("Network error"));
