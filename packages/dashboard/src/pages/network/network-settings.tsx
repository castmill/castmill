...
import { Button, FormItem, useToast, Switch, Dropdown } from "@castmill/ui-common";
...
const NetworkSettings: Component = () => {
  ...
  const [invitationOnlyOrgAdmins, setInvitationOnlyOrgAdmins] = createSignal(false);
    ...
    <div class={styles["network-page"]}>
      ...
      <div class={styles["section"]}>
        ...
        <div class={styles["form-grid"]}>
          ...
          >
            <span class={styles["help-text"]}>{t("network.identity.nameHelp")}</span>
          </FormItem>
          ...
          >
            ...
            <Show when={!emailError()}>
              <span class={styles["help-text"]}>{t("network.identity.emailHelp")}</span>
            </Show>
          </FormItem>
          ...
          >
            <span class={styles["help-text"]}>{t("network.identity.logoHelp")}</span>
          </FormItem>
          ...
          >
            <span class={styles["help-text"]}>{t("network.identity.copyrightHelp")}</span>
          </FormItem>
          ...
          >
            <span class={styles["help-text"]}>{t("network.identity.privacyPolicyUrlHelp")}</span>
          </FormItem>
          ...
          <div class={styles["form-item"]}>
            ...
            />
            <span class={styles["help-text"]}>{t("network.identity.defaultLanguageHelp")}</span>
          </div>
        </div>
      </div>
      ...
      <div class={styles["section"]}>
        ...
        <div class={styles["form-row"]}>
          ...
          <div class={styles["domain-display"]}>
            ...
            <span class={styles["domain-note"]}>{t("network.domain.note")}</span>
          </div>
        </div>
      </div>
      ...
      <div class={styles["section"]}>
        ...
        <div class={styles["toggle-row"]}>
          <div class={styles["toggle-info"]}>
            <span class={styles["toggle-label"]}>{t("network.access.invitationOnly")}</span>
        ...
        <div class={styles["toggle-row"]}>
          ...
          <Switch
            ...
            disabled={false}
            onToggle={() => setInvitationOnlyOrgAdmins(!invitationOnlyOrgAdmins())}
          />
        </div>
      </div>
      ...
      <div class={styles["actions"]}>
        <Show when={isModified()}>
          <Button label={t("common.reset")} color="secondary" onClick={handleReset} />
        </Show>
        <Button
