...
describe("NetworkOrganizations", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.mocked(NetworkService.listOrganizations).mockResolvedValue(mockOrganizations);
  });
  ...
  it("creates a new organization", async () => {
    ...
    await waitFor(() => {
      expect(NetworkService.createOrganization).toHaveBeenCalledWith("New Organization");
