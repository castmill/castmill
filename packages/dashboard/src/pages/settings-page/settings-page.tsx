...
const SettingsPage: Component = () => {
  ...
  const handleResetTour = async () => {
    ...
    try {
      const updatedProgress = await OnboardingService.resetProgress(currentUser.id);
  ...
  const handleAddNewPasskey = async () => {
    ...
    try {
      ...
      const { challenge, user_id, challenge_token } = await UserService.createCredentialChallenge(
        currentUser.id,
      );
          ...
          <div class="settings-content">
            ...
            <div class="form-actions">
              ...
              <Show when={saveSuccess()}>
                <span class="success-message">{t("settings.profileUpdatedSuccess")}</span>
              </Show>
              <Show when={error()}>
          ...
          <div class="settings-content">
            <div class="passkey-info">
              ...
              <div class="passkey-list">
                ...
                <Show
                  when={!credentialsLoading() && credentialsError() && credentials().length === 0}
                >
                        ...
                        <Show when={editingCredential() !== credential.id}>
                          <div class="passkey-details">
                            ...
                            <span class="passkey-date">
                              {t("settings.added")}{" "}
                              <Timestamp value={credential.inserted_at} mode="relative" />
                            </span>
                          </div>
            ...
            <div class="language-options">
              <For each={SUPPORTED_LOCALES}>
                {(localeInfo) => (
                  ...
                  >
                    <span class="language-code">{localeInfo.code.toUpperCase()}</span>
          ...
          <div class="settings-content">
            ...
            <Show when={showResetTourConfirm()}>
              <div class="onboarding-reset-confirmation">
                <p>
                  <strong>{t("settings.onboardingTourResetConfirmTitle")}</strong>
                </p>
