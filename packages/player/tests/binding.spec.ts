...
describe("Binding Type Guards", () => {
  describe("isBinding", () => {
    it("should return true for simple bindings", () => {
      ...
      expect(isBinding({ key: "options.title", default: "Default" })).to.be.true;
    });

    it("should return false for switch bindings", () => {
      expect(isBinding({ switch: { key: "data.type", cases: {} } })).to.be.false;
    });

    it("should return false for conditional bindings", () => {
      expect(isBinding({ cond: { key: "data.value", gte: 0, then: "a", else: "b" } })).to.be.false;
    });
  ...
  describe("isSwitchBinding", () => {
    it("should return true for switch bindings", () => {
      expect(isSwitchBinding({ switch: { key: "data.type", cases: { a: 1 } } })).to.be.true;
    });
  ...
  describe("isConcatBinding", () => {
    it("should return true for concat bindings with array", () => {
      ...
      expect(isConcatBinding({ concat: [{ key: "data.value" }, "px"] })).to.be.true;
    });
  ...
  describe("isAnyBinding", () => {
    it("should return true for all binding types", () => {
      ...
      expect(isAnyBinding({ switch: { key: "data.type", cases: {} } })).to.be.true;
      expect(
        isAnyBinding({
...
describe("resolveKey", () => {
  ...
  it("should resolve with globals", () => {
    const [result, error] = resolveKey("data.items[@index]", config, {}, { index: 2 });
    expect(error).to.be.undefined;
...
describe("resolveConditionalBinding", () => {
  ...
  describe("gte operator", () => {
    it("should return then value when value >= threshold", () => {
      ...
      expect(resolveConditionalBinding(binding, config, {}, {})).to.equal("high");
    });
    ...
    it("should return then value when value equals threshold", () => {
      ...
      expect(resolveConditionalBinding(binding, config, {}, {})).to.equal("non-negative");
    });
    ...
    it("should return else value when value < threshold", () => {
      ...
      expect(resolveConditionalBinding(binding, config, {}, {})).to.equal("negative");
    });
  });
  ...
  describe("gt operator", () => {
    it("should return then value when value > threshold", () => {
      ...
      expect(resolveConditionalBinding(binding, config, {}, {})).to.equal("greater");
    });
    ...
    it("should return else value when value equals threshold", () => {
      ...
      expect(resolveConditionalBinding(binding, config, {}, {})).to.equal("not positive");
    });
  });
  ...
  describe("lte operator", () => {
    it("should return then value when value <= threshold", () => {
      ...
      expect(resolveConditionalBinding(binding, config, {}, {})).to.equal("non-positive");
    });
  ...
  describe("eq operator", () => {
    it("should return then value when value equals", () => {
      ...
      expect(resolveConditionalBinding(binding, config, {}, {})).to.equal("zero");
    });
    ...
    it("should return else value when value does not equal", () => {
      ...
      expect(resolveConditionalBinding(binding, config, {}, {})).to.equal("not zero");
    });
  });
  ...
  it("should resolve context values", () => {
    ...
    expect(resolveConditionalBinding(binding, config, context, {})).to.equal("positive");
  });
});
...
describe("Integration: Stock Ticker Use Cases", () => {
  ...
  it("should resolve direction-based color using switch", () => {
    ...
    const upResult = resolveOption(binding, stockConfig, stockConfig.data.quotes[0], {});
    expect(upResult).to.equal("#00C853");

    // Test with 'down' direction
    const downResult = resolveOption(binding, stockConfig, stockConfig.data.quotes[1], {});
    expect(downResult).to.equal("#FF1744");

    // Test with 'neutral' direction (falls to default)
    const neutralResult = resolveOption(binding, stockConfig, stockConfig.data.quotes[2], {});
  ...
  it("should resolve change-based color using conditional", () => {
    ...
    // Positive change
    const positiveResult = resolveOption(binding, stockConfig, stockConfig.data.quotes[0], {});
    expect(positiveResult).to.equal("#00C853");

    // Negative change
    const negativeResult = resolveOption(binding, stockConfig, stockConfig.data.quotes[1], {});
    expect(negativeResult).to.equal("#FF1744");

    // Zero change (should be positive/non-negative)
    const zeroResult = resolveOption(binding, stockConfig, stockConfig.data.quotes[2], {});
